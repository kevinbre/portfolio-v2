...
export const ProjectCard = ({ project }: { project: Project }) => {
  ...
  return (
    <article className="group relative flex h-full flex-col overflow-hidden rounded-xl border border-line bg-abyss transition-all duration-300 hover:border-brand/60 hover:shadow-[0_0_36px_-14px_var(--color-brand)]">
      <div
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <div className="mt-5 flex items-end justify-between gap-4">
          ...
          <div className="relative z-10 flex shrink-0 items-center gap-3 text-faint">
            {repository && (
              <a
                href={repository}
                target="_blank"
